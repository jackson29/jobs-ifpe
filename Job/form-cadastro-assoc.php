    ...
    <form action="addAssociacoes.php" method="post">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-4">
          ...
          <input type="numeric" class="form-control" id="cnpj" placeholder="CNPJ" name="cnpj" required>
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="form-group col-md-4">
          ...
          <input type="numeric" class="form-control" id="fone" placeholder="Telefone Fixo (81) 0000-0000" name="fone">
        </div>

        <div class="form-group col-md-4">
          <label for="cel">Celular:</label>
          <input type="numeric" class="form-control" id="cel" placeholder="(DDD)número" name="cel" required>
        </div>
      ...
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="nomeRes">nome/ sobreNome</label>
